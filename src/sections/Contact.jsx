    ...
    <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'} pb-20`}>
      <section id='contact' className={`${darkMode ? 'dark bg-gray-800' : 'light bg-red-100'} lg:w-[95%] w-full h-fit m-auto rounded-xl grid lg:grid-cols-2 grid-cols-1 justify-center items-center lg:px-36 px-6 py-20 gap-10`}>
        <div data-aos='zoom-in' className='bg-white dark:bg-black p-10 flex flex-col justify-center items-start gap-4 rounded-xl'>
          ...
          <input type="text" placeholder='Enter your name here' className='w-full px-6 py-3 border-2 border-gray-200 rounded-xl' />
          ...
          <button className='bg-red-600 w-full py-3 text-md px-8 text-white font-semibold rounded-xl hover:bg-black dark:hover:bg-red-700 cursor-pointer'>SEND EMAIL</button>
        </div>
        <div className='flex flex-col justify-center items-start gap-8 lg:p-20 p-6'>
          <h1 data-aos='zoom-in' data-aos-delay='200' className='text-red-500 dark:text-white'>REACH US</h1>
          <h1 className='text-black w-full text-[40px] font-semibold leading-10 dark:text-white'>Lorem ipsum consectetur adipisicing elit. Ipsa fugiat fuga consequatur enim.</h1>
          <p data-aos='zoom-in' data-aos-delay='600' className='text-xl text-gray-600 text-justify dark:text-white'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui nostrum animi illum corporis. Sunt cumque earum veniam ullam, vitae.</p>
